        ...
        if dropdown_auto_id == "boxDate":
            try:
                ...
                try:
                    ...
                    pyautogui.press('right', presses=15, interval=0.02)
                    pyautogui.press('backspace', presses=15, interval=0.02)
                    time.sleep(0.3)
                ...
                logger.exception(f"Unexpected error while selecting date: {e}")
                return False
